...
// Make the query:
$result = mysql_query("SELECT * FROM  `Students` WHERE  `Status` !=1");		
...
echo '
		...
		{
			echo '<td align="left"><font color="red">Incomplete</font></td></tr>';
		}
